...
export const METADATA_ALLOWLIST: Partial<Record<string, string[]>> = {
  ...
  'timeline.event.recorded': ['eventType', 'caseId'],
  ...
  'workflow.created': ['name', 'caseType', 'workflowId'],
  'workflow.version.created': ['workflowId', 'version'],
  'workflow.version.published': ['versionId', 'version'],
  'workflow.transition.executed': ['fromStateId', 'toStateId', 'caseId'],
  'hearing.created': ['caseId', 'date'],
  'hearing.updated': [],
  'hearing.deleted': ['hearingId'],
  'hearing.outcome.recorded': ['outcome', 'status'],
  'deadline.created': ['caseId', 'dueDate'],
  'deadline.updated': ['status'],
  'deadline.completed': ['completionEvidence'],
  'deadline.rule.created': ['name'],
  'task.created': ['caseId', 'priority', 'dueDate'],
  'task.updated': ['status'],
  ...
  'intake.created': ['clientType'],
  'intake.reviewed': [],
  'intake.approved': [],
  'intake.rejected': [],
  'hold.created': [],
  'hold.released': [],
  'retention.policy.set': ['targetType', 'retainYears'],
  'audit.exported': [],
  'integration.configured': ['key'],
  'webhook.registered': [],
  'webhook.rotated': [],
  'webhook.disabled': [],
  'ai.requested': ['taskType'],
  'ai.approved': [],
  'ai.rejected': [],
  'notification.rule.created': ['eventType'],
  'notification.rule.updated': [],
  'notification.sent': ['recipientCount'],
  'import.validated': ['entityType'],
  'import.approved': [],
  'import.completed': ['created'],
  'import.rolled_back': [],
  'export.completed': ['entityType', 'rowCount'],
  'breakglass.activated': ['caseId', 'subjectMembershipId'],
  'breakglass.revoked': ['grantId'],
  'breakglass.used': ['grantId'],
  'role.created': ['roleKey'],
  'role.permission.granted': ['roleKey', 'permissionKeys'],
  'role.permission.revoked': ['roleKey', 'permissionKeys'],
  'member.role.revoked': ['roleKey'],
