...
Mandatory rule: follow strict single-responsibility file organization.
...
Feature → UI responsibility → Component → API responsibility → Validation → Authorization → Business operation → Data access → External integration → Database operation
